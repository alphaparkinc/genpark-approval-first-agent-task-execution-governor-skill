# genpark-approval-first-agent-task-execution-governor-skill
...
> **GenPark AI Agent Skill** -- Human-in-the-loop approval gate for autonomous AI agent task execution (Soloop style)
